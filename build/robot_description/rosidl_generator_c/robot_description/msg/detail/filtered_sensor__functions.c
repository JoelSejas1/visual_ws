...
robot_description__msg__FilteredSensor__init(robot_description__msg__FilteredSensor * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    robot_description__msg__FilteredSensor__fini(msg);
    return false;
  }
  return true;
}
...
robot_description__msg__FilteredSensor__create(void)
{
  ...
  robot_description__msg__FilteredSensor * msg = (robot_description__msg__FilteredSensor *)allocator.allocate(sizeof(robot_description__msg__FilteredSensor), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_description__msg__FilteredSensor));
  bool success = robot_description__msg__FilteredSensor__init(msg);
  if (!success) {
...
robot_description__msg__FilteredSensor__Sequence__init(robot_description__msg__FilteredSensor__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_description__msg__FilteredSensor * data = NULL;

  if (size) {
    data = (robot_description__msg__FilteredSensor *)allocator.zero_allocate(size, sizeof(robot_description__msg__FilteredSensor), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_description__msg__FilteredSensor__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robot_description__msg__FilteredSensor__fini(&data[i - 1]);
      }
...
robot_description__msg__FilteredSensor__Sequence__fini(robot_description__msg__FilteredSensor__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_description__msg__FilteredSensor__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_description__msg__FilteredSensor__Sequence * array = (robot_description__msg__FilteredSensor__Sequence *)allocator.allocate(sizeof(robot_description__msg__FilteredSensor__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_description__msg__FilteredSensor__Sequence__init(array, size);
  if (!success) {
...
robot_description__msg__FilteredSensor__Sequence__destroy(robot_description__msg__FilteredSensor__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_description__msg__FilteredSensor__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_description__msg__FilteredSensor__Sequence__are_equal(const robot_description__msg__FilteredSensor__Sequence * lhs, const robot_description__msg__FilteredSensor__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_description__msg__FilteredSensor__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_description__msg__FilteredSensor__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_description__msg__FilteredSensor);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_description__msg__FilteredSensor * data =
      (robot_description__msg__FilteredSensor *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_description__msg__FilteredSensor__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_description__msg__FilteredSensor__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_description__msg__FilteredSensor__copy(
