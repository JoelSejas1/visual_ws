...
static const _FilteredSensor_type_support_symbol_names_t _FilteredSensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_description, msg, FilteredSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_description, msg, FilteredSensor)),
  }
};
...
{
  return &::robot_description::msg::rosidl_typesupport_cpp::FilteredSensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_description, msg, FilteredSensor)() {
  return get_message_type_support_handle<robot_description::msg::FilteredSensor>();
}
